...
. Añada las herramientas de ONTAP para el proveedor de almacenamiento de VMware vSphere 10,1 al vCenter Server y. link:../configure/registration-process.html["Registre el proveedor de VASA en vCenter Server"].
...
+
Una vez que se ha detenido el antiguo proveedor de VASA, vCenter Server conmuta al nodo de respaldo a las herramientas de ONTAP para VMware vSphere 10,1. Todos los almacenes de datos y máquinas virtuales se pueden acceder y se sirven desde las herramientas de ONTAP para VMware vSphere 10,1.
