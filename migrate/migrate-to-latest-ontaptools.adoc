...
. Instale herramientas de ONTAP para el adaptador SRA de VMware vSphere 10,2 en sitios tanto de protección como de recuperación siguiendo los pasos del link:../protect/configure-on-srm-appliance.html["Configure el SRA en el dispositivo SRM"]
