...
. Instale herramientas de ONTAP para el adaptador SRA de VMware vSphere 10,1 en sitios tanto de protección como de recuperación siguiendo los pasos del link:../protect/configure-on-srm-appliance.html["Configurar el SRA en el dispositivo VMware Live Site Recovery"]
