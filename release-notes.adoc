...
Para obtener más información, consulte la https://library.netapp.com/ecm/ecm_download_file/ECMLP3327064["Notas de la versión de ONTAP tools para VMware vSphere 10,2"^].
