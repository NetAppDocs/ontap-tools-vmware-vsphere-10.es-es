...
summary: Configura SRA con el asistente de VMware Live Site Recovery Array Manager para conectar los sitios protegidos y de recuperación a las máquinas virtuales de almacenamiento. 
---
= Configura SRA usando el gestor de arrays en ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
