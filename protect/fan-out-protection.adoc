...
. Agrega los datastores a la protección del clúster de hosts siguiendo link:../manage/edit-hostcluster-protection.html["Modifique el clúster de hosts protegido"]. Agrega ambos tipos de políticas: asíncronas y síncronas.
