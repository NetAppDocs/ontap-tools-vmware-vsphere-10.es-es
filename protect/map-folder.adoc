...
summary: Asigna carpetas entre los sitios protegidos y de recuperación para preparar los flujos de trabajo de conmutación por error de VMware Live Site Recovery. 
---
= Configura las asignaciones de carpetas en ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Resultado
La página Folder Mappings muestra los recursos del sitio protegido y los recursos del sitio de recuperación. Puedes seguir los mismos pasos para otras carpetas de tu entorno.
