...
summary: Configura los almacenes de datos provisionales en el centro de recuperación para reservar espacio en el inventario de vCenter para las máquinas virtuales protegidas. 
---
