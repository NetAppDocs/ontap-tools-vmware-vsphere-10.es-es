...
summary: Configura SRA en el dispositivo VMware Live Site Recovery para habilitar los flujos de trabajo de recuperación ante desastres con ONTAP tools. 
---
= Configura SRA en el dispositivo VMware Live Site Recovery usando ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Habilita los servicios SRA en ONTAP tools Manager. Para más información, consulta la sección link:../manage/enable-services.html["Habilitar servicios"].
* Agrega servidores vCenter a la aplicación ONTAP tools for VMware vSphere. Para más información, consulta la sección link:../configure/add-vcenter.html["Agregar servidores vCenter"].
* Agrega backends de almacenamiento a ONTAP tools for VMware vSphere. Para más información, consulta la sección link:../configure/add-storage-backend.html["Agregar backends de almacenamiento"].
