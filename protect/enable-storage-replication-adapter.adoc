...
summary: Activa SRA en ONTAP tools para dar soporte a los flujos de trabajo de recuperación ante desastres de VMware Live Site Recovery. 
---
...
.Antes de empezar
* Deberías haber configurado tu instancia de vCenter Server y haber configurado los hosts ESXi.
...
.Pasos
. Inicia sesión en la interfaz de gestión del appliance VMware Live Site Recovery usando la URL: `\https://<srm_ip>:5480`, y luego ve a Adaptadores de replicación de almacenamiento en la interfaz de gestión del appliance VMware Live Site Recovery.
