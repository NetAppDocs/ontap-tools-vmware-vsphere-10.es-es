...
Para ver las ONTAP tools for VMware vSphere , seleccione *Menú* en la parte superior de vSphere Client y haga clic en *Administración* y luego en *Roles* a la izquierda. Los siguientes privilegios deben incluirse en el rol asignado al usuario de vCenter responsable de implementar o incorporar vCenter. Asegúrese de que estos privilegios estén configurados como un requisito previo para el proceso de implementación o incorporación.
