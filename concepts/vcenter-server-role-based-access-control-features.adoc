...
Puede ver las herramientas de ONTAP para las funciones estándar de VMware vSphere seleccionando *Roles* en la página inicial de vSphere Client. Los roles que las herramientas de ONTAP para VMware vSphere proporcionan le permiten realizar las siguientes tareas:
