...
sidebar: sidebar 
keywords:  
summary: 'Puedes activar servicios opcionales como VASA Provider, la importación de la configuración de vVols y la recuperación ante desastres (SRA) mediante ONTAP tools Manager.' 
---
