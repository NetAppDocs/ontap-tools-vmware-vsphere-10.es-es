...
| Tarjeta de alertas | La tarjeta de Alertas muestra las alertas de ONTAP tools clasificadas por tipo, incluidas las alertas a nivel de nodo HA. Puedes ver alertas detalladas seleccionando el enlace del recuento, que te lleva a la página de alertas filtrada por el tipo de alerta seleccionado. 
