...
---
= Eliminar la protección de clúster de host en ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
En esta página, puedes supervisar los clústeres de host protegidos, el estado de protección, la relación SnapMirror y el estado. Selecciona los grupos de coherencia para ver la capacidad, los almacenes de datos asociados y los grupos secundarios.
