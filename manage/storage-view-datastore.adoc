...
summary: La vista de almacenamiento ONTAP en la pestaña Configurar de ONTAP tools for VMware vSphere proporciona datos relacionados con el almacén de datos y sus volúmenes. 
---
