...
summary: Puedes editar las relaciones SnapMirror del clúster de host protegido. Puedes añadir, modificar y eliminar las relaciones. Sin embargo, no puedes editar el nombre del grupo de consistencia. 
---
