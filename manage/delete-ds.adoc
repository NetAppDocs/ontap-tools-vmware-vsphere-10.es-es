...
summary: La acción Eliminar almacén de datos elimina el almacén de datos. En el caso de un almacén de datos NFS o VMFS, aparece un cuadro de diálogo con la lista de máquinas virtuales que están utilizando el almacén de datos. 
---
