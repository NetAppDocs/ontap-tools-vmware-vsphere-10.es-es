...
[role="lead"]
Gestiona el registro de auditoría en ONTAP tools for VMware vSphere. Los registros de auditoría muestran quién realizó una acción, qué ocurrió, cuándo sucedió, la fuente de la solicitud y si la acción tuvo éxito o falló.
