...
Puedes usar las herramientas ONTAP para VMware vSphere con VMware vCenter Server Virtual Appliance (vCSA). Debes implementar las herramientas ONTAP para VMware vSphere en un entorno vSphere compatible que incluya hosts ESXi.
