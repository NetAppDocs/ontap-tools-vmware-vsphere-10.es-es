...
summary: 'Amplía una implementación de ONTAP tools a una configuración de alta disponibilidad (HA) para aumentar la resiliencia y admitir más contenedores por servicio.' 
---
= Flujo de trabajo de despliegue de alta disponibilidad para ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Para configurar los almacenes de datos de vVols, debes habilitar el servicio VASA Provider. Registra el VASA provider en vCenter y asegúrate de que tus políticas de almacenamiento cumplen los requisitos de HA, incluidas las configuraciones adecuadas de red y almacenamiento.
