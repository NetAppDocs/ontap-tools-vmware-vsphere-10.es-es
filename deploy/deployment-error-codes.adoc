...
* Revisa los registros en /var/log/post-deploy-upgrade.log.
...
Si el despliegue falla con el código de error 114, completa los siguientes pasos:

* Habilita el shell de diagnóstico.
* Ejecuta el siguiente comando: `sudo perl /home/maint/scripts/post-deploy-upgrade.pl --internal_cert_update_collection`
* Revisa los registros en `/var/log/otvng/post-deploy-upgrade.log`.
