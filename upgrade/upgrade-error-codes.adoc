...
| 052 | La ISO puede ser la misma que la versión actual o dos versiones por encima de la versión actual. | Utilice una versión ISO compatible para actualizar desde su versión actual. 
