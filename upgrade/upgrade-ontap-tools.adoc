...
** Desde la interfaz de usuario del administrador del sistema de ONTAP, busque el volumen por su nombre en la barra de búsqueda y, a continuación, abra ese volumen seleccionando el nombre. Vaya a snapshot y añada la snapshot de ese volumen.
