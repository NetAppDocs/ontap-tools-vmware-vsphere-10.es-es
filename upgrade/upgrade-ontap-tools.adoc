...
sidebar: sidebar 
keywords: upgrade 
summary: Cuando se actualiza desde las herramientas de ONTAP para VMware vSphere 10,0 y 10,1 a 10,2, se crea un volumen de recuperación y se llevan a cabo todos los detalles necesarios en el volumen de recuperación. 
---
...
[role="lead"]
Cuando se actualiza desde las herramientas de ONTAP para VMware vSphere 10,0 y 10,1 a 10,2, se crea un volumen de recuperación y se llevan a cabo todos los detalles necesarios en el volumen de recuperación. El volumen de recuperación puede usarse para recuperar las herramientas de ONTAP para la configuración de VMware vSphere si es necesario recuperar la configuración. Si va a realizar una actualización a nivel de parches de las herramientas de ONTAP para VMware vSphere 10,2, se utiliza el mismo volumen de recuperación y se actualizan los detalles. La actualización es compatible con puestas en marcha tanto de alta disponibilidad como con otras de alta disponibilidad.
