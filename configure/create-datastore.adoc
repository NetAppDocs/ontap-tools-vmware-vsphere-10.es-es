...
. Selecciona una VM de almacenamiento en el panel *Almacenamiento*. Proporciona el *nombre de grupo iniciador personalizado* en la sección *Opciones avanzadas* según sea necesario. Puedes elegir un igroup existente para el datastore o crear un nuevo igroup con un nombre personalizado.
+
