...
Si la compatibilidad con MetroCluster está habilitada en ONTAP, incorpore los clústeres de origen y destino como backends de almacenamiento locales o globales.
